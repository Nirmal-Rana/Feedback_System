        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StudentRollNo = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    StudentDepartment = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DocumentAttachments_Issues_IssueId",
                        column: x => x.IssueId,
            ...
            migrationBuilder.InsertData(
                table: "Admins",
                columns: new[] { "Id", "Email", "FullName", "LastLogin", "Password", "Username" },
                values: new object[] { 1, "admin@texascollege.edu.np", "Administrator", new DateTime(2026, 5, 11, 1, 58, 27, 944, DateTimeKind.Local).AddTicks(6619), "Admin@1991", "Admin" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DocumentAttachments_IssueId",
